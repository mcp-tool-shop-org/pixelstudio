    ...
    it('shows metrics when available', () => {
      ...
      useSandboxStore.setState({
        metrics: {
          ...
          previewWidth: 32,
          previewHeight: 32,
          loopDiagnostics: { firstLastDelta: 2.5, hint: 'Good loop' },
          driftDiagnostics: { driftMagnitude: 1.2, hint: 'Low drift' },
          timingDiagnostics: {
    ...
    it('shows stale indicator when session changed', () => {
      ...
      useSandboxStore.setState({
        metrics: {
          ...
          previewWidth: 32,
          previewHeight: 32,
          loopDiagnostics: { firstLastDelta: 0, hint: '' },
          driftDiagnostics: { driftMagnitude: 0, hint: '' },
